...
DEMO_DATA = {
    ...
    "notifications": [
        {"id": "N0001", "message": "Q4 Performance Reviews due next Friday", "type": "warning", "target": "all", "sender": "Sarah Mitchell", "sender_id": "U0002", "sender_role": "hr", "time": datetime.now().isoformat(), "read_by": []},
        {"id": "N0002", "message": "Team standup at 10 AM tomorrow", "type": "info", "target": "employee", "sender": "David Chen", "sender_id": "U0003", "sender_role": "teamleader", "time": datetime.now().isoformat(), "read_by": []},
        {"id": "N0003", "message": "Alice Johnson is eligible for promotion!", "type": "success", "target": "hr", "sender": "AI System", "sender_id": "SYSTEM", "sender_role": "system", "time": datetime.now().isoformat(), "read_by": []},
        {"id": "N0004", "message": "Kevin Anderson has high attrition risk", "type": "danger", "target": "hr", "sender": "AI System", "sender_id": "SYSTEM", "sender_role": "system", "time": datetime.now().isoformat(), "read_by": []},
        {"id": "N0005", "message": "New training program: Advanced React - Register now", "type": "info", "target": "all", "sender": "Sarah Mitchell", "sender_id": "U0002", "sender_role": "hr", "time": datetime.now().isoformat(), "read_by": []},
    ],
    "weekly_updates": [],
    "login_logs": [],
    "system_activities": [],
